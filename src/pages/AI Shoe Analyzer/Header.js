...
const Header = () => {
   ...
   return (
      <>
         <section className="hero__area p-relative mt--120" style={{height:"800px"}}>
               ...
               <div className="container">
                  <div className="row" >
                     <div className="col-xl-6 col-lg-5 order-last">
                        <div className="hero__thumb-wrapper ml-100 mt--100 scene p-relative">
                           <div className="hero__thumb one d-none d-md-block d-lg-none d-xl-block">
                     ...
                     <div className="col-xl-6 col-lg-7 d-flex flex-col justify-center">
