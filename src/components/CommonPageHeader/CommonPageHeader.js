...
const CommonPageHeader = ({ title, subtitle}) => {
   return (
      <>
         <section className="page__title p-relative d-flex align-items-center fix" style={{ background: `url(assets/img/slider/02/1.jpg)`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
